...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="bg-[#f6fff4] min-h-screen">
      {/* Header */}
       <header className="fixed w-full top-0 left-0 h-[109px] flex justify-between items-center px-4 lg:px-20 z-50 bg-[#f6fff4]/95 backdrop-blur-sm">
        <img
        ...
        {/* Hero Section */}
        <section 
          className="pt-[145px] pb-20 px-8 lg:px-32 relative overflow-hidden transition-opacity duration-300"
          style={{ 
        ...
        <div className="absolute inset-0 pointer-events-none">
          <img
            className="absolute right-0 top-0 w-[388px] h-[339px] opacity-60"
            alt="Solar ray"
            src="/images/solar-ray-2.svg"
          />
           <img
             className="absolute right-0 top-0 w-[729px] h-[716px] opacity-100 z-20"
             alt="Solar ray"
        ...
        <section 
          className="py-20 px-8 lg:px-32 bg-white/50 transition-opacity duration-300"
          style={{ 
        ...
        <section 
          className="py-20 px-8 lg:px-32 mb-16 transition-opacity duration-300"
          style={{ 
        ...
        {/* CTA Section */}
        <section 
          className="py-10 px-8 lg:px-32 bg-[#e5f1e5] transition-opacity duration-300"
          style={{ 
        ...
        {/* Footer */}
        <footer 
          className="py-16 px-8 lg:px-32 bg-[#ffffff45] transition-opacity duration-300"
          style={{ 
